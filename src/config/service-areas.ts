...
export const cities: readonly City[] = [
  {
    ...
    note: "Our home court. Trust and estate cases for San Jose families are heard in the Probate Division at 191 N. First Street, a few blocks from where we meet clients.",
  },
  {
    name: "Palo Alto",
    slug: "palo-alto",
  ...
  },
  {
    ...
    slug: "sunnyvale",
    county: "Santa Clara County",
    note: "Sunnyvale trust disputes go to the San Jose probate courthouse. We meet Sunnyvale clients by video or by appointment.",
  },
  {
    name: "Mountain View",
    slug: "mountain-view",
  ...
  },
  {
    ...
    slug: "campbell",
    county: "Santa Clara County",
    note: "Campbell is minutes from the San Jose courthouse; we meet Campbell clients by appointment or video.",
  },
  {
    name: "Milpitas",
    slug: "milpitas",
