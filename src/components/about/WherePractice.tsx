...
import { cities, courts, regions } from '@/config/service-areas';
        ...
        <Reveal stagger className="mt-10 grid gap-8 md:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-4 text-body text-ink-2">
              ...
              {regions[regions.length - 1]}. A Fremont trust dispute is usually filed in Alameda
              County; everything else on this list goes to San Jose.
            </p>
            <Link
              href="/service-areas/"
